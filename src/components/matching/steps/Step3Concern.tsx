        ...
        <div className="w-full max-w-3xl mx-auto animate-fadeIn">
            ...
            <div className="text-center mb-8 space-y-4">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-slate-900">
                    ...
                    <span style={{ background: 'linear-gradient(90deg, #8B7355, #C9A962)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', color: 'transparent' }}>모두 선택해주세요</span>
                </h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 mb-8">
              ...
              `}
                            style={isSelected ? { borderColor: '#C9A962', backgroundColor: 'rgba(212, 184, 106, 0.1)', boxShadow: '0 0 0 1px #C9A962' } : {}}
                        >
              ...
              `}
                                style={isSelected ? { backgroundColor: '#C9A962', borderColor: '#8B7355' } : {}}
                            >
                ...
                ${isSelected ? '' : 'text-slate-700 group-hover:text-slate-900'}
              `}
                                style={isSelected ? { color: '#8B7355' } : {}}
                            >
               ...
               `}
                                style={isSelected ? { backgroundColor: '#C9A962' } : {}}
                            />
          ...
          `}
                    style={selectedTags.length > 0 ? { background: 'linear-gradient(135deg, #8B7355 0%, #C9A962 100%)', boxShadow: '0 10px 30px -5px rgba(139, 115, 85, 0.4)' } : {}}
                >
                    {selectedTags.length > 0 && (
